...
//	}
	 ...
	 * 
	 * */
    public void m3u8download(String m3u8url ,String srcurl,int tsname_length , int timegap ,String uuids,TspojoDao tspojoDao ) throws ParseException  {
	        ...
	        for(int i = 0; i < 2; i++){ 	        	
	        	...
	        	if( i == 0) {
	        		try {
		        		...
		        		System.out.println("tmpd1date:"+tmpd1date.getYear());
